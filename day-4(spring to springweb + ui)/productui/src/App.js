...
const App = () => {
  ...
  return (
    <div className="container">
      <h1 className="title" >Product Telusko </h1>

      <div className="form-container">
        <h2>Add Product to Telusko</h2>
        <form className="form">
      ...
      <div className="product-list">
        <h2>Products</h2>
        <button className="filter-button" onClick={fetchProducts}>Add All products</button>
        <button className="filter-button" onClick={fetchOutOfWarrantyProducts}>Products Out of Warranty </button>
        <ul className="list">
